...
6. **Dónde y cómo aplicar**: playbook completo y explícito en **`private/job-search.md`** (fuera de git a propósito: el repo es público y ahí está la estrategia y el target salarial). Resumen: LinkedIn con búsquedas guardadas y alertas (aplicar en las primeras 24h), Wellfound + Welcome to the Jungle + Himalayas, YC Work at a Startup, empresas que ya contratan LATAM (Lumenalta, Near, Howdy, Toptal), y el sistema semanal: 10-15 aplicaciones dirigidas + 5 outreach directos a design managers, cada link con su `go.html?ref=<empresa>`, follow-up al día 4 guiado por el tracker.
