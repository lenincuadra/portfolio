...
### Q1 Revenue Increase Driven Purely by UX Intervention

<sub>Q1 vs Q1 · No pricing changes · No campaign changes · No external growth drivers</sub>

## Performance Graph

[Insert Q1 vs Q1 indexed revenue comparison chart]

Use indexed values for clarity:
- Q1 Previous Year = 100
- Q1 Current Year = 321

The graph should visually emphasize the growth from 100 to 321 (+221%), with minimal visual noise.

Include a bold "221%" label directly above the growth bar to reinforce the impact visually.

---

## Montironi Automotive – E-commerce Optimization Case
...
Scope: Full website UX redesign + conversion channel strategy.

---

## Problem

The original inquiry flow:
...
[Insert screenshot of original tire inquiry flow]
...
Measured as Q1 vs Q1 year-over-year.
